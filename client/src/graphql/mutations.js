...
export const DIYETISYEN_SIL=gql`
mutation DiyetisyenSil($silinecekDiyetisyenEmail: String!) {
  diyetisyenSil(silinecekDiyetisyenEmail: $silinecekDiyetisyenEmail)
}
`

export const SIFRE_DEGISTIR=gql`
mutation SifreDegistir($sifreSifirlama: sifreSifirlamaBilgileri!) {
  sifreDegistir(sifreSifirlama: $sifreSifirlama)
}
`

export const DANISAN_GUNCELLE=gql`
mutation DanisanGuncelle($guncellenecekDanisan: GuncellenecekDanisanBilgisi!, $danisanEmail: String!) {
  danisanGuncelle(guncellenecekDanisan: $guncellenecekDanisan, danisanEmail: $danisanEmail)
}
`
